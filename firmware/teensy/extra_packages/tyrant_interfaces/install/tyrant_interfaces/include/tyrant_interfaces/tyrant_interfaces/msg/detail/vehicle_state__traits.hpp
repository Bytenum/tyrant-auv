...
#ifndef TYRANT_INTERFACES__MSG__DETAIL__VEHICLE_STATE__TRAITS_HPP_
#define TYRANT_INTERFACES__MSG__DETAIL__VEHICLE_STATE__TRAITS_HPP_
  ...
  std::ostream & out)
{
  ...
  // member: estimator_status
  {
    out << "estimator_status: ";
    rosidl_generator_traits::value_to_yaml(msg.estimator_status, out);
  }
  out << "}";
...
inline void to_yaml(
  const tyrant_interfaces::msg::VehicleState & msg,
  std::ostream & out, size_t indentation = 0)
{
...
inline std::string to_yaml(const tyrant_interfaces::msg::VehicleState & msg)
{
  return tyrant_interfaces::msg::to_yaml(msg);
}

template<>
inline const char * data_type<tyrant_interfaces::msg::VehicleState>()
{
  return "tyrant_interfaces::msg::VehicleState";
}

template<>
inline const char * name<tyrant_interfaces::msg::VehicleState>()
{
  return "tyrant_interfaces/msg/VehicleState";
}

template<>
struct has_fixed_size<tyrant_interfaces::msg::VehicleState>
...
template<>
struct has_bounded_size<tyrant_interfaces::msg::VehicleState>
...
template<>
struct is_message<tyrant_interfaces::msg::VehicleState>
  : std::true_type {};

}  // namespace rosidl_generator_traits

#endif  // TYRANT_INTERFACES__MSG__DETAIL__VEHICLE_STATE__TRAITS_HPP_
