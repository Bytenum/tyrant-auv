...
bool tyrant_interfaces__msg__vehicle_reference__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("tyrant_interfaces.msg._vehicle_reference.VehicleReference", full_classname_dest, 57) == 0);
  }
  tyrant_interfaces__msg__VehicleReference * ros_message = _ros_message;
  {  // header
...
{
  /* NOTE(esteve): Call constructor of VehicleReference */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("tyrant_interfaces.msg._vehicle_reference");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "VehicleReference");
