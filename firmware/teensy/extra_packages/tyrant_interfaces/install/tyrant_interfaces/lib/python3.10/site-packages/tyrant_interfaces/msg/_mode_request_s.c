...
bool tyrant_interfaces__msg__mode_request__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("tyrant_interfaces.msg._mode_request.ModeRequest", full_classname_dest, 47) == 0);
  }
  tyrant_interfaces__msg__ModeRequest * ros_message = _ros_message;
  {  // request_id
...
PyObject * tyrant_interfaces__msg__mode_request__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("tyrant_interfaces.msg._mode_request");
