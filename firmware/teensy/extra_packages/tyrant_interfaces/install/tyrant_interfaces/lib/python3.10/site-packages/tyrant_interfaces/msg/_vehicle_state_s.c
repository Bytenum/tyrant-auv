...
bool tyrant_interfaces__msg__vehicle_state__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("tyrant_interfaces.msg._vehicle_state.VehicleState", full_classname_dest, 49) == 0);
  }
  tyrant_interfaces__msg__VehicleState * ros_message = _ros_message;
  {  // header
  ...
  {  // estimator_status
    PyObject * field = PyObject_GetAttrString(_pymsg, "estimator_status");
    if (!field) {
      return false;
    }
    assert(PyLong_Check(field));
    ros_message->estimator_status = (uint8_t)PyLong_AsUnsignedLong(field);
    Py_DECREF(field);
  }
...
PyObject * tyrant_interfaces__msg__vehicle_state__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("tyrant_interfaces.msg._vehicle_state");
  ...
  {  // estimator_status
    PyObject * field = NULL;
    field = PyLong_FromUnsignedLong(ros_message->estimator_status);
    {
      int rc = PyObject_SetAttrString(_pymessage, "estimator_status", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
